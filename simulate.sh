...
then
    echo "Usage: $0 <TEST>"
    echo "Running ASM Test: ../tests/custom/hello_world/custom_test_template.S"
    src0=../tests/custom/hello_world/custom_test_template.S
else
    src0=$1
fi

#MODIFIED COPY OF cva6/verif/regress/smoke-tests-cv64a6_imafdc_sv39.sh
